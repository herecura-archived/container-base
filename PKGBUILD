...
license=('GPL')
depends=('busybox')
provides=('sh' 'bash' 'acpid' 'shadow' 'binutils' 'net-tools' 'iputils' 'gawk' 'coreutils' 'util-linux' 'bridge-utils' 'e2fsprogs' 'kbd' 'ncurses' 'diffutils' 'cron' 'kmod' 'inetutils' 'dos2unix' 'ed' 'grep' 'fbset' 'psmisc' 'hdparm' 'i2c-tools' 'net-tools' 'ifenslave' 'ifplugd' 'findutils' 'procps-ng' 'iproute2' 'ipcalc' 'less' 'lsof' 'pciutils' 'usbutils' 'man-db' 'dosfstools' 'sysstat' 'dnsutils' 'patch' 'powertop' 'rfkill' 'rpmextract' 'run-parts' 'sed' 'smem' 'syslog-ng' 'tar' 'traceroute' 'unzip' 'sharutils' 'wget' 'which' 'whois'
